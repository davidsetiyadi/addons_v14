odoo.define('web_hover_tooltip.widget', function (require) {
"use strict";
...
var Hover2Widget = AbstractField.extend({
    className: "oe_hover2",
    jsLibs: [
